...
<html>
  <head>
    ...
    <title>leSirve | www.lesirve.com</title>
    ...
    <link rel="stylesheet" href="{{asset('css2/_all-skins.min.css')}}">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Edwin Andres Mendez Vanegas</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{{ route('logout') }}" method="POST" class="btn btn-default btn-flat">Cerrar</a>
                    </div>
                  </li>
                </ul>
              </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/adm/articulos"><i class="fa fa-circle-o"></i> Artículos</a></li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">ADMINISTRACION DE TU PAGINA WEB </h3>
